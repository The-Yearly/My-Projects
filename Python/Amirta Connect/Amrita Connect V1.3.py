...
def changebiotk():
    ...
    biol=Label(bioc,text="Enter Your Age",bg="Coral1",fg="White",font=10)
...
def myprofile(usernam):
    ...
    edbio=Button(mypr,text="Edit Bio",bg="Coral1",fg="White",command=closemyprtochangebio)
    edbio.place(x=230,y=570)
