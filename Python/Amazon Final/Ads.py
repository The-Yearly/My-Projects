...
def ad8():
    print("\n=============================================Ad==================================================")
    print("                                       Karishma And Elza Consultancy")
    print("    Come To Karishma And Elza Consultancy For All The Resources You'll Need For Your Dreams To Come True ")
    print("                                       Book Now For A Free Consulatation")
    print("                                        -Shaping Miracles Since 2005")
    print("\n================================================================================================")
def ad():
    ads=random.randrange(1,9)
    if ads==1:
        ad1()
    if ads==2:
        ad2()
