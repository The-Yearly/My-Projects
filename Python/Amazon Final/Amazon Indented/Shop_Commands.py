...
def additem():
    cats = {
        ...
        "Furniture": ["Beds", "Tables", "Shelfs", "Chairs", "Sofas", "Other"],
        "Books": [
            "Fiction",
            "Non Fiction",
            "Biography",
        ...
        "Media": ["Movies", "Songs", "Games", "Pendrives", "Cd", "Blueray", "Other"],
        "Other": ["Other"],
    }
    cat = list(cats.keys())
    name = input(
        "Enter The Name Of The Item (Name Should Be Between 4 and 30 Characters And All Special Symbols Are Removed) "
    )
    name = af(name)
    if len(name) < 101 and len(name) > 3:
        while True:
            ...
            print("0 ) Cancel")
            scatsel = int(
                input("Select Category Of The Item From The Given Categories(index) ")
            )
            if scatsel > 0 and scatsel < len(cat) + 1:
                ...
                while True:
                    ...
                    ssubsel = int(
                        input(
                            "Select Sub-Category Of The Item From The Given Sub-Categories(index)) "
                        )
                    )
                    if ssubsel > 0 and ssubsel < len(subs) + 1:
                        ...
                        while True:
                            stocksel = int(
                                input(
                                    "Enter The Available Quantity Of The Item (Enter 0 To Cancel) "
                                )
                            )
                            if stocksel > 0 and stocksel < 100000:
                                ...
                                while True:
                                    costsel = int(
                                        input(
                                            "Enter The Selling Price Of This Item (Enter 0 To Cancel) "
                                        )
                                    )
                                    if costsel > 0 and costsel < 1000000:
                                        ...
                                        while True:
                                            keysel = input(
                                                "Enter Key Word Through Which People Can Also Search For(Key Words Can Brand Names ,Models etc Also All Special Symbols Are Removed) (enter 'cancel' to Cancel) "
                                            )
                                            keysel = af(keysel)
                                            if (
                                                len(keysel) > 1
                                                ...
                                                while True:
                                                    desel = input(
                                                        "Enter Description Of The Product(Description Should Be Between 2 And 800 Characters All Special Symbols Are Removed) (Enter 'cancel' To Cancel) "
                                                    )
                                                    desel = af(desel)
                                                    if (
                                                        len(desel) > 1
                                                        ...
                                                        print(
                                                            "Description Should Be Between 2 And 800 Characters"
                                                        )
                                                break
                                            elif keysel == "cancel":
                                                break
                                                ...
                                                print(
                                                    "Length Of Keys Should Be Between 2 To 25 Characters"
                                                )
                                        break
                                    elif costsel == 0:
                                        break
                                        ...
                                        print(
                                            "You Cant Sell This Item At This Selling Price (Selling Price Entered Should Be Between 0 And 1000000)"
                                        )
                                break
                            elif stocksel == 0:
                                break
                                ...
                                print(
                                    "Invalid Amount Of Stock (Stock Entered Should Be Between 0 And 100000)"
                                )
                        break
                    elif ssubsel == 0:
                        break
    ...
    while True:
        ...
        if chawan == 1:
                ...
                if scatsel > 0 and scatsel < len(k) + 1:
                    ...
                    while True:
                        ...
                        for h in subs:
                            print(subs.index(h) + 1, ")", h)
                        subsel = int(
                            input("Select A Sub-Category From Above Options(Indexs) ")
                        )
            ...
            if costsel > 0 and costsel < 10000000:
                ...
                print(
                    "Invalid Amount Of Stock (Stock Entered Should Be Between 0 And 1000000)"
                )
        elif chawan == 6:
            keysel = input(
                "Enter The New Key Word(Like Brand Name etc..) (No Special Symbols Allowed) "
            )
            keysel = af(keysel)
            ...
            dessel = input(
                "Enter The New Description (Description Should Be Between 2 And 800 Characters And No Special Symbols Allowed) "
            )
            dessel = af(keysel)
